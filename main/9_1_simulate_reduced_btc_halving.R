...
if (setting == "actual") {
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_btc_halving_actual.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_btc_halving_original_original_cw144.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_btc_halving_original_original_original.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_btc_halving_cw144_cw144_cw144.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_btc_halving_original_asert_cw144.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_btc_halving_original_asert_asert.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_btc_halving_asert_asert_asert.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_btc_halving_cw144_asert_asert.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_btc_halving_asert_asert_cw144.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_btc_halving_cw144_original_original.rds")
