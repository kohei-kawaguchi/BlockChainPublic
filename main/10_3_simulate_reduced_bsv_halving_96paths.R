...
workers = makeCluster(4, type = "PSOCK")
...
epoch_currency_header <-
  ...
  dplyr::mutate(blockheight_btc = sum(blockheight * (currency == "BSV"))) %>%
  dplyr::ungroup() %>%
...
foreach::foreach(i = 1:iter,
  ...
  if (setting == "actual") {
    ...
    mypath <- paste("output/10_3_simulate_reduced_bsv_halving/epoch_currency_bsv_halving_actual_", 
                    i,
                    ".rds",
                    sep = "") 
    ...
    mypath <- paste("output/10_3_simulate_reduced_bsv_halving/epoch_currency_bsv_halving_original_original_cw144_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_3_simulate_reduced_bsv_halving/epoch_currency_bsv_halving_original_original_original_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_3_simulate_reduced_bsv_halving/epoch_currency_bsv_halving_cw144_cw144_cw144_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_3_simulate_reduced_bsv_halving/epoch_currency_bsv_halving_original_asert_cw144_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_3_simulate_reduced_bsv_halving/epoch_currency_bsv_halving_original_asert_asert_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_3_simulate_reduced_bsv_halving/epoch_currency_bsv_halving_asert_asert_asert_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_3_simulate_reduced_bsv_halving/epoch_currency_bsv_halving_cw144_asert_asert_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_3_simulate_reduced_bsv_halving/epoch_currency_bsv_halving_asert_asert_cw144_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
