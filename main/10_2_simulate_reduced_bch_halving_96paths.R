...
epoch_currency_header <-
  ...
  dplyr::mutate(blockheight_btc = sum(blockheight * (currency == "BCH"))) %>%
  dplyr::ungroup() %>%
...
foreach::foreach(i = 1:iter,
  ...
  if (setting == "actual") {
    ...
    mypath <- paste("output/10_2_simulate_reduced_bch_halving/epoch_currency_bch_halving_actual_", 
                    i,
                    ".rds",
                    sep = "") 
    ...
    mypath <- paste("output/10_2_simulate_reduced_bch_halving/epoch_currency_bch_halving_original_original_cw144_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_2_simulate_reduced_bch_halving/epoch_currency_bch_halving_original_original_original_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_2_simulate_reduced_bch_halving/epoch_currency_bch_halving_cw144_cw144_cw144_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_2_simulate_reduced_bch_halving/epoch_currency_bch_halving_original_asert_cw144_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_2_simulate_reduced_bch_halving/epoch_currency_bch_halving_original_asert_asert_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_2_simulate_reduced_bch_halving/epoch_currency_bch_halving_asert_asert_asert_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_2_simulate_reduced_bch_halving/epoch_currency_bch_halving_cw144_asert_asert_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
    ...
    mypath <- paste("output/10_2_simulate_reduced_bch_halving/epoch_currency_bch_halving_asert_asert_cw144_",
                    i,
                    ".rds",
                    sep = "") 
    saveRDS(epoch_currency, file = mypath)
