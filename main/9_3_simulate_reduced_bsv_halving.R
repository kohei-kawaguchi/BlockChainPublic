...
epoch_currency_header <-
  ...
  dplyr::mutate(blockheight_bsv = sum(blockheight * (currency == "BSV"))) %>%
  dplyr::ungroup() %>%
  dplyr::filter(blockheight_bsv >= (max(blockheight_bsv) - 2016)) %>%
  dplyr::select(-blockheight_bsv) %>%
  dplyr::arrange(epoch) %>%
  dplyr::left_join(
    rate_estimate,
    by = "currency"
...
if (setting == "actual") {
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_bsv_halving_actual.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_bsv_halving_original_original_cw144.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_bsv_halving_original_original_original.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_bsv_halving_cw144_cw144_cw144.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_bsv_halving_original_asert_cw144.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_bsv_halving_original_asert_asert.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_bsv_halving_asert_asert_asert.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_bsv_halving_cw144_asert_asert.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_bsv_halving_asert_asert_cw144.rds")
  ...
  saveRDS(epoch_currency, file = "output/epoch_currency_bsv_halving_cw144_original_original.rds")
